...
use App\Service\Vehicle\Validation\Validations\DrivingSchoolExists;
...
class VehicleCreaterValidation
{
    ...
    public function validate(VehicleEntity $vehicleEntity)
    {
        ...
        $drivingSchooExists = new DrivingSchoolExists($this->notificationError, $this->vehicleStorage);
