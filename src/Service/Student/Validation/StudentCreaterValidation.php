...
use App\Service\Student\Validation\Validations\DrivingSchoolExists;
...
class StudentCreaterValidation
{
    ...
    public function validate(StudentEntity $studentEntity)
    {
        ...
        $drivingSchooExists = new DrivingSchoolExists($this->notificationError, $this->studentStorage);
        $drivingSchooExists->check($studentEntity);
    }
}